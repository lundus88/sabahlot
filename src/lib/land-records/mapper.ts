...
export function mapCloudPoint(row: CloudLandPointRow): CloudLandPoint {
  return {
    ...
    altitudeAccuracyM: row.altitude_accuracy_m,
    heading: row.heading,
    speed: row.speed,
    ...
    sourceDatum: row.source_datum,
    instrumentMake: row.instrument_make,
    instrumentModel: row.instrument_model,
    instrumentSerial: row.instrument_serial,
    firmwareVersion: row.firmware_version,
    correctionSource: row.correction_source,
    correctionAgeSeconds: row.correction_age_seconds,
    pdop: row.pdop,
    satelliteCount: row.satellite_count,
    tiltStatus: row.tilt_status,
    signalIntegrityStatus: row.signal_integrity_status,
    sampleCount: row.sample_count,
    occupationSeconds: row.occupation_seconds,
    note: row.note,
