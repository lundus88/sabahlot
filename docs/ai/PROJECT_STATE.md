...
_Last updated: 2026-07-27 (post-merge reconciliation for PR #35 — Points cloud-write UI wiring merged to `main@a1e73a0950ac052c10e85657f1e75578b07ba3db`). Previous update: 2026-07-26 (pre-merge recording of the same sprint's implementation, now superseded by this reconciliation). Update this file at the end of every merged sprint — it is the single source of truth for "what is actually true right now," not the sprint reports themselves._
